; (function () {
  ...
  function search (sum, arr) {
    ...
    return _search(sum, arr)
  }

  console.time('searchTime')
  console.log(search(22, [ 10, 20, 30, 40, 50, 60, 70, 1, 2, 76, 3, 5, 9, 24, 6, 4, 8, 7, 12, 12, 23, 13, 34, 56, 67, 34, 34, 45, 223, 123, 23, 32, 34, 45 ]))
